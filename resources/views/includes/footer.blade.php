      ...
      <div class="col-lg-4">
        <div class="footer-content">
          <a href="index.html" class="logo d-flex align-items-center mb-4">
            <span class="sitename">MindFit</span>
          </a>
          <p class="mb-4">
  ...
  <div class="footer-bottom">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="copyright">
            <p>© <span>Copyright</span> <a href="https://github.com/Denngrh"> <strong class="px-1 sitename">MyWebsite</strong></a> <span>All Rights Reserved</span></p>
          </div>
        </div>
        <div class="col-lg-6">
          ...
          <div class="credits">
            Designed by <a href="https://github.com/Denngrh">Pion Dev</a>
          </div>
        </div>
      </div>
    </div>
